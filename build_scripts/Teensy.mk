...
MCU = cortex-m4 -mthumb -fsingle-precision-constant
...
ARCHITECTURE  = avr
AVR_TOOLS_DIR = $(call dir_if_exists,$(ARDUINO_DIR)/hardware/tools/arm)
...
# processor stuff
ifndef MCU
    MCU := $(call PARSE_TEENSY,$(BOARD_TAG),build.flags.cpu)
endif
...
#LDFLAGS +=  $(call PARSE_TEENSY,$(BOARD_TAG),build.flags.ld) $(call PARSE_TEENSY,$(BOARD_TAG),build.flags.libs)
